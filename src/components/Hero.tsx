  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Freire FPV</h1>
        <p className="text-xl md:text-2xl mb-8">Grabaciones aéreas únicas desde Málaga</p>
        <Button color="primary" size="lg" href="#servicios">
          Descubrir Servicios
        </Button>
      </div>
    </div>
